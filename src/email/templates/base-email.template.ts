          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px 40px; text-align: center; border-top: 1px solid #e5e7eb;">
              ...
              <div style="margin-top: 20px;">
                ...
                <a href="https://daytradedak.com/terms/terms-conditions#privacy" style="color: #6b7280; font-size: 12px; text-decoration: none;">
                  Política de privacidad
                </a>
                <span style="color: #d1d5db; margin: 0 10px;">|</span>
                <a href="https://daytradedak.com/terms/terms-conditions#terms" style="color: #6b7280; font-size: 12px; text-decoration: none;">
